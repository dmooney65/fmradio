 ...
 */
exports.getLowPassFIRCoeffs =  function(sampleRate, halfAmplFreq, length) {
  length += (length + 1) % 2;
 ...
 * @constructor
 */
exports.Downsampler = function(inRate, outRate, coefficients) {
...
function SSBDemodulator(inRate, outRate, filterFreq, upper, kernelLen) {
  ...
  var downsamplerI = this.Downsampler(inRate, outRate, coefs);
  var downsamplerQ = this.Downsampler(inRate, outRate, coefs);
...
function AMDemodulator(inRate, outRate, filterFreq, kernelLen) {
  var coefs = this.getLowPassFIRCoeffs(inRate, filterFreq, kernelLen);
  var downsamplerI = this.Downsampler(inRate, outRate, coefs);
  var downsamplerQ = this.Downsampler(inRate, outRate, coefs);
  var sigRatio = inRate / outRate;
  var relSignalPower = 0;
 ...
 * @constructor
 */
exports.FMDemodulator =  function(inRate, outRate, maxF, filterFreq, kernelLen) {
 ...
 * @constructor
 */
exports.StereoSeparator = function(sampleRate, pilotFreq) {
  var AVG_COEF = 9999;
  var STD_THRES = 400;
 ...
 * @constructor
 */
exports.Deemphasizer = function(sampleRate, timeConstant_uS) {
 ...
 */
exports.iqSamplesFromUint8 = function(buffer, rate) {
 ...
 */
exports.shiftFrequency = function(IQ, freq, sampleRate, cosine, sine) {
